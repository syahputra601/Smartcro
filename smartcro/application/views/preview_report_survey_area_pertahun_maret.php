...
<!-- START BAGIAN TEXT INPUT -->
  <!-- START FOR JATIM -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_maret_jatim" id="txt_Rata_rata_ServiceNoType_1_maret_jatim" value="<?= $Fix_Rata_rata_ServiceNoType_1_jatim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_maret_jatim" id="txt_Rata_rata_ServiceNoType_2_maret_jatim" value="<?= @$Fix_Rata_rata_ServiceNoType_2_jatim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_maret_jatim" id="txt_Rata_rata_ServiceNoType_3_maret_jatim" value="<?= @$Fix_Rata_rata_ServiceNoType_3_jatim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_maret_jatim" id="txt_Rata_rata_ServiceNoType_4_maret_jatim" value="<?= @$Fix_Rata_rata_ServiceNoType_4_jatim ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_maret_jatim" id="txt_Rata_rata_SalesNoType_1_maret_jatim" value="<?= @$Fix_Rata_rata_SalesNoType_1_jatim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_maret_jatim" id="txt_Rata_rata_SalesNoType_2_maret_jatim" value="<?= @$Fix_Rata_rata_SalesNoType_2_jatim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_maret_jatim" id="txt_Rata_rata_SalesNoType_3_maret_jatim" value="<?= @$Fix_Rata_rata_SalesNoType_3_jatim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_maret_jatim" id="txt_Rata_rata_SalesNoType_4_maret_jatim" value="<?= @$Fix_Rata_rata_SalesNoType_4_jatim ?>" readonly>
  <!-- END FOR JATIM -->
  <!-- START FOR JAKARTA -->
